...
public:
    ...
    Triangle(std::vector<Eigen::Vector3d> &vertices, uint32_t v_0, uint32_t v_1, uint32_t v_2)
    {
        ...
        vertex_1 = v_1;
        vertex_2 = v_2;
        A = ((vertices[v_1].y() - vertices[v_0].y()) * (vertices[v_2].z() - vertices[v_0].z()) -
             (vertices[v_1].z() - vertices[v_0].z()) * (vertices[v_2].y() - vertices[v_0].y()));
        B = ((vertices[v_1].z() - vertices[v_0].z()) * (vertices[v_2].x() - vertices[v_0].x()) -
             (vertices[v_1].x() - vertices[v_0].x()) * (vertices[v_2].z() - vertices[v_0].z()));
        C = ((vertices[v_1].x() - vertices[v_0].x()) * (vertices[v_2].y() - vertices[v_0].y()) -
